...
###### 2.1.1.2.2.1. 查看tmpfs命令：



![](images/1569584708275.png)

###### 2.1.1.2.2.2. 系统默认开启，大小约为物理内存一半



###### 2.1.1.2.2.3. 查看物理内存利用情况
...
#### 2.1.2.8. redis-cluster支持

https://github.com/steve0511/resty-redis-cluster

 

### 2.1.3. redis2-nginx-module 
...
#### 2.2.0.7. nginx url_hash

Nginx第三方模块，在转发请求时如果后端服务器宕机，会导致503错误

#### 2.2.0.8. lua-resty-http
...
### 2.2.3. lua-resty-http实现一致性hash负载均衡
